...
public class CustomizedArrayListOfInteger {
    private int size;// number of elements
    private int[] elementData;
    private final static int DEFAULT_SIZE = 50;

    public CustomizedArrayListOfInteger(){
        this(DEFAULT_SIZE);
    }
    public CustomizedArrayListOfInteger(int capacity){
        if(capacity < 0){
    ...
    public static void main(String[] args){
       CustomizedArrayListOfInteger intArr = new CustomizedArrayListOfInteger();
       int[] arr = {1,6,4,3,2,5};
        intArr.add(8);
        intArr.add(2);
        intArr.add(7);
